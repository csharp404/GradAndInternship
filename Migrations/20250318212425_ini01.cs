        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PathDocument = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UrlDocument = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CommentFromDoctor = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectDetails_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectDetails_Doctors_DoctorId",
                        column: x => x.DoctorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectDetails_DepartmentId",
                table: "ProjectDetails",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectDetails_DoctorId",
                table: "ProjectDetails",
                column: "DoctorId");
